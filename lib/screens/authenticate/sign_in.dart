  ...
  Widget build(BuildContext context) {
    return loading ? Loading() : Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('Sign In to The Beans'),
        actions: <Widget>[
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: NetworkImage('https://image.freepik.com/free-vector/brown-coffee-seamless-pattern_1085-2010.jpg'),
              fit: BoxFit.cover,
            )
        ),
             ...
             RaisedButton(
               ...
               onPressed: () async {
                 if(_formKey.currentState.validate()){
                   ...
                   if(result == null){
                      setState((){
                        error = 'COULD NOT SIGN IN WITH THOSE CREDIANTIALS';
                        loading=false;
                      });
                   }
                 }
